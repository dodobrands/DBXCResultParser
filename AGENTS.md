...
peekiesdk is a Swift package that parses `.xcresult` files generated by Xcode to produce structured reports of build and test results. It provides programmatic access to test cases, code coverage, and warnings for CI/CD pipelines and automated scripts.
...
**DTO Layer** (`Sources/peekiesdk/Models/DTO/`)
...
The package exports:
- **peekiesdk**: Core parsing library (includes parsing and formatting)
