...
Peekie is a Swift package that parses `.xcresult` files generated by Xcode to produce structured reports of build and test results. It provides programmatic access to test cases and code coverage for CI/CD pipelines and automated scripts.
